...
export default function Footer() {
  return (
    <footer className="bg-black-950 text-black-100 py-12 px-6">
      {/* Top Section */}
      ...
      {/* Bottom Section */}
      <div className="border-t border-gray-700 pt-6 text-center text-sm text-gray-500 space-y-2">
        <p>Stoxie © 2025 | Data provided for educational purposes only</p>
